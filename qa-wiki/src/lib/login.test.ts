...
test('Sign in to Wikipedia', async ({ page }) => {
    ...
    await page.goto('https://en.wikipedia.org/wiki/Login')
    await page.locator('#pt-login-2').click()
    await page.getByPlaceholder("Enter your username").fill('Malini gowda')
    await page.locator('[name="wpPassword"]').fill('Test@1234')
